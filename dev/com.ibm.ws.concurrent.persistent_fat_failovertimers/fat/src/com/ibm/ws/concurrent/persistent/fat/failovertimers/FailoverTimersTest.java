...
public class FailoverTimersTest extends FATServletClient {
    ...
    @ClassRule
    public static final JdbcDatabaseContainer<?> testContainer = DatabaseContainerFactory.create(DatabaseContainerType.DerbyClient, false);
    ...
    public static void setUp() throws Exception {
        ...
        DatabaseContainerUtil.createTableResource(testContainer,
                                                  "CREATE TABLE TIMERLOG (TIMERNAME VARCHAR(254) NOT NULL PRIMARY KEY, COUNT INT NOT NULL, SERVERNAME VARCHAR(254) NOT NULL)");
