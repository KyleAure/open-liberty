...
IBM-Provision-Capability: \
  ...
  osgi.identity; filter:="(!(type=osgi.subsystem.feature)(|(osgi.identity=io.openliberty.persistenceContainer-3.1)(osgi.identity=io.openliberty.persistenceContainer-3.2)))"
-features=\
