 ...
 *******************************************************************************/
package test.connector.schedule.internal;
 ...
 */
@Component(configurationPid = "test.connector.schedule",
...
public class ScheduleTestServiceImpl implements RuntimeUpdateListener {
    long m_delay;
    ...
    protected void activate(BundleContext bundleContext, Map<String, Object> properties) {
        ...
        SerializableSchedule schedule = (SerializableSchedule) properties.get("schedule");

        System.out.println(CLASS_NAME + ".activate.Exit. " + "schedule: " + schedule.toString());
