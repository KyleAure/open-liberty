...
import static componenttest.annotation.SkipIfSysProp.DB_Derby;
...
@SkipIfSysProp({DB_Derby, DB_Informix, DB_Sybase}) //Only use this class if using a database that has a supported container
public class MultiplePersistentExecutorsContainerTest extends FATServletClient{
