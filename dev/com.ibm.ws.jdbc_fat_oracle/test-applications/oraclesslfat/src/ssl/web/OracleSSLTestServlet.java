...
public class OracleSSLTestServlet extends FATServlet {
    ...
    @Resource(lookup = "jdbc/oracle-truststore")
    private DataSource ds_oracle_truststore;
    ...
    @Test
    public void testOracleTrustStore() throws Exception {
        try (Connection con = ds_oracle_truststore.getConnection(); Statement stmt = con.createStatement()) {
            stmt.execute("SELECT 1 FROM DUAL");
        }
    }
}
